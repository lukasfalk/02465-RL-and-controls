...
def fk(x,u):
    ...
    f_euler = dmodel.f(x,u) # the function dmodel.f accept various parameters. Perhaps their name can give you an idea?
    return f_euler
...
def dfk_dx(x,u):
    ...
    # TODO: 1 lines missing.
    f_euler_derivative = dmodel.f_jacobian(x, u)[0]
